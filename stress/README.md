...
- O nome da instância Evolution da conexão que vai receber a carga

## Variáveis de ambiente

| Variável | Obrigatória | Descrição |
|---|---|---|
| `EVOLUTION_INSTANCE_NAME` | Sim | Instância da conexão — o webhook resolve por ela; nome desconhecido é descartado |
| `EVOLUTION_API_KEY` | Não | Header `apikey`, só se a API roda com `EVOLUTION_VALIDATE_APIKEY=true` |
...
docker run -p 8089:8089 \
  -e EVOLUTION_INSTANCE_NAME=sua-instancia \
...
|---------|----------|-------------|---------|
| **worker** | `EVOLUTION_OUTBOUND_MODE` | `mock` | Impede envio real de mensagens (spam + 400 em número falso) |
