...
export const NAV_TABS_BY_GROUP: Record<string, NavTab[]> = {
  ...
  operacao: [
    ...
    { label: "Disparador", href: "/disparador/contatos", requires: "disparador.capturar" },
    { label: "Grupos (Disp.)", href: "/disparador/grupos", requires: "disparador.capturar" },
    { label: "API keys", href: "/disparador/api-keys", requires: "disparador.api_key.manage" },
