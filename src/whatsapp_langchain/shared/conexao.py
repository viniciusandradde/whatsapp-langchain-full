...
Cada `conexao` é uma linha (WABA, Evolution) ligada a uma empresa. O webhook
resolve `empresa_id` + `default_agent_id` por lookup no `phone_number_id`
(WABA) ou no `instance_name` (Evolution).
