...
2. **Fila global sem justiça entre empresas** — um burst do hospital atrasava todos. **Entregue em 18/09**: o claim ordena os candidatos pela posição na fila da própria empresa (contando o que ela já tem em voo) antes da idade — a 1ª mensagem de cada empresa vem antes da 2ª de qualquer outra, quem ocupa mais slots fica atrás; sem estado, sem slot ocioso (uma empresa só = FIFO). Teto fixo por empresa foi descartado porque desperdiçaria capacidade quando só uma tem tráfego. E2E: hospital com 5 conversas em burst + PME 1 s depois → PME sai em 2º.
