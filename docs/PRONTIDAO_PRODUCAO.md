...
| R11 | **SSRF em `download_media`** — segue redirects sem allowlist de host | 🟡 Média (P2) | P | `shared/midia_processing.py:84-93` | Exigir https, bloquear IPs privados/loopback/link-local, não anexar auth cross-host, `follow_redirects=False` |
